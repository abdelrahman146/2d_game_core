...
class_name GCStaticHost2D
## Actor host for static objects: doors, switches, breakables, traps, platforms, props.
## Add GCBehavior children to compose interactions and state changes.
...
## category lookups instead of a custom tag list.
